...
from fast_distance import Point, calculate_total_distance

def main():
    print("Parse JSON in Python, and create Point objects in Rust from Python. Calculate total distance in Rust.")
    print("This means we move every point between Rust and Python, and then back again.")
